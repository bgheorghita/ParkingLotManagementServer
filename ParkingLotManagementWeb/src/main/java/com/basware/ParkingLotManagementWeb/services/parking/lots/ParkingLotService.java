...
public interface ParkingLotService {
    TicketOutputDto generateTicket(User user, Vehicle vehicle) throws TicketException, SaveException, ServiceNotAvailable, TooManyRequestsException, FullParkingLotException;
